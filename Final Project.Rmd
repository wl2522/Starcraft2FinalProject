...
week_subset <- data.frame(c(sc[3:5], sc[6:8]))
corr_week_subset <- cor(week_subset)
week <- corrplot(corr_week_subset, method = 'number', diag = FALSE, type = 'upper', col = viridis(256), title = 'Significant Correlations Among Skills and Time Variables', mar=c(0,0,1,0))
